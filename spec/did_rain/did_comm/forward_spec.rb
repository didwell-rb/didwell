...
RSpec.describe DIDRain::DIDComm::Protocols::Routing::Forward do
  it "detects forward messages" do
    ...
    expect(DIDRain::DIDComm::Protocols::Routing::Forward.forward?(fwd)).to be true
  end

  it "rejects non-forward messages" do
    msg = { "type" => "http://example.com/test", "body" => {} }
    expect(DIDRain::DIDComm::Protocols::Routing::Forward.forward?(msg)).to be false
  end
  ...
  it "parses forward messages" do
    ...
    parsed = DIDRain::DIDComm::Protocols::Routing::Forward.parse(fwd)
