...
RSpec.describe "Encryption with various curves" do
  ...
  describe "Anoncrypt with P-384" do
    it "encrypts and decrypts with A256CBC-HS512" do
      pack_result = DIDRain::DIDComm.pack_encrypted(message, to: "did:example:bob#key-p384-1",
  ...
  describe "Anoncrypt with P-521" do
    it "encrypts and decrypts with A256GCM" do
      pack_result = DIDRain::DIDComm.pack_encrypted(message, to: "did:example:bob#key-p521-1",
                                            resolvers_config: resolvers_alice,
                                            pack_config: DIDRain::DIDComm::PackEncrypted::Config.new(
  ...
  describe "Error cases" do
    it "raises on unknown recipient DID" do
      ...
      msg.to = nil
      expect {
        DIDRain::DIDComm.pack_encrypted(msg, to: "did:example:unknown",
                                resolvers_config: resolvers_alice,
                                pack_config: DIDRain::DIDComm::PackEncrypted::Config.new(forward: false))
    ...
    it "raises on tampered ciphertext" do
      ...
      expect {
        DIDRain::DIDComm.unpack(JSON.generate(tampered), resolvers_config: resolvers_bob)
