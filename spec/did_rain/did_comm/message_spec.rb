...
RSpec.describe DIDRain::DIDComm::Message do
  describe "#to_hash" do
    ...
    it "auto-generates id" do
      msg = DIDRain::DIDComm::Message.new(type: "test", body: {})
      expect(msg.id).to match(/\A[0-9a-f-]+\z/)
    end

    it "does not default thid to id" do
      msg = DIDRain::DIDComm::Message.new(id: "my-id", type: "test", body: {})
    ...
    it "preserves explicit thid" do
      msg = DIDRain::DIDComm::Message.new(id: "my-id", type: "test", body: {}, thid: "thread-1")
  ...
  describe ".from_hash" do
    it "parses a valid message" do
      ...
      msg = DIDRain::DIDComm::Message.from_hash(h)
    ...
    it "raises on missing required fields" do
      expect { DIDRain::DIDComm::Message.from_hash({}) }.to raise_error(DIDRain::DIDComm::MalformedMessageError)
      expect { DIDRain::DIDComm::Message.from_hash({ "id" => "1" }) }.to raise_error(DIDRain::DIDComm::MalformedMessageError)
    end

    it "raises on invalid typ" do
      h = { "id" => "1", "type" => "t", "body" => {}, "typ" => "wrong" }
      expect { DIDRain::DIDComm::Message.from_hash(h) }.to raise_error(DIDRain::DIDComm::MalformedMessageError)
    end
    ...
    it "round-trips through JSON" do
      ...
      json = msg.to_json
      parsed = DIDRain::DIDComm::Message.from_json(json)
