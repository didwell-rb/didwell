...
RSpec.describe "enc algorithm validation" do
  def build_protected(header_hash)
    ...
    DIDRain::DIDComm::Crypto::KeyUtils.base64url_encode(json)
  end
  ...
  describe "validate_anoncrypt_jwe" do
    it "accepts A256CBC-HS512" do
      ...
      expect { DIDRain::DIDComm::Crypto::Validation.validate_anoncrypt_jwe(msg) }.not_to raise_error
    end
    ...
    it "rejects unsupported enc algorithm" do
      ...
      expect {
        DIDRain::DIDComm::Crypto::Validation.validate_anoncrypt_jwe(msg)
      }.to raise_error(DIDRain::DIDComm::MalformedMessageError, /Unsupported enc algorithm for anoncrypt/)
    end
  ...
  describe "validate_authcrypt_jwe" do
    ...
    def build_authcrypt_msg(enc:)
      kids = ["did:example:bob#key-x25519-1"]
      apv = DIDRain::DIDComm::Crypto::KeyUtils.calculate_apv(kids)
      apu = DIDRain::DIDComm::Crypto::KeyUtils.base64url_encode(sender_kid)
    ...
    it "accepts A256CBC-HS512" do
      ...
      expect { DIDRain::DIDComm::Crypto::Validation.validate_authcrypt_jwe(msg) }.not_to raise_error
    end

    it "rejects A256GCM" do
      msg = build_authcrypt_msg(enc: "A256GCM")
      expect {
        DIDRain::DIDComm::Crypto::Validation.validate_authcrypt_jwe(msg)
      }.to raise_error(DIDRain::DIDComm::MalformedMessageError, /Unsupported enc algorithm for authcrypt/)
    end
