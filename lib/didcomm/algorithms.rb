...
module DIDComm
  ...
  module AnonCryptAlg
    A256CBC_HS512_ECDH_ES_A256KW = Algs.new(alg: "ECDH-ES+A256KW", enc: "A256CBC-HS512")
    XC20P_ECDH_ES_A256KW = Algs.new(alg: "ECDH-ES+A256KW", enc: "XC20P")
    A256GCM_ECDH_ES_A256KW = Algs.new(alg: "ECDH-ES+A256KW", enc: "A256GCM")
  ...
  module AuthCryptAlg
    A256CBC_HS512_ECDH_1PU_A256KW = Algs.new(alg: "ECDH-1PU+A256KW", enc: "A256CBC-HS512")
