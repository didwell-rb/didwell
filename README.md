...
- **DID Core** — [W3C DID Core](https://www.w3.org/TR/did-1.1/) types (DID Document, Verification Method, Resolvers)
- **DIDComm v2** — [DIDComm v2](https://identity.foundation/didcomm-messaging/spec/v2.1/) messaging:
